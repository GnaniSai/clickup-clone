...
const WorkSpaceCards = () => {
  return (
    <button className='transition-transform duration-100 ease-in-out scale-100 [transform:translateZ(1px)] transform-origin-center rounded-xl border border-[#ceceea] flex flex-col items-center pb-4 justify-center'>
  ...
  return (
    <div className="w-full flex my-10 items-start justify-center">
      <div className="relative w-[70%] flex justify-center">
        <div className="text-white w-full h-[500px] overflow-hidden blur-[2px] shadow-[inset_0_0_60px_rgba(107,114,128,0.5)]' p-2 border border-white rounded-xl">
          <img src={workspace1} alt="workspace1" className="w-full h-full object-cover object-top" />
        </div>

        <div className="absolute -right-30 -top-7 z-10 w-[430px] border-2 border-white p-2 rounded-2xl ">
          <div className="relative px-6 py-4 rounded-xl text-center bg-white">
            ...
            <div className="flex justify-center w-full">
              <Button href="#" text="Get Started" fontSize="16px" />
            </div>
