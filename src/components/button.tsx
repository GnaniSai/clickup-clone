...
export const Button = ({
  ...
  } flex items-center gap-2 justify-center rounded-[10px] text-${color} bg-${bgColor} whitespace-nowrap tracking-tight font-bold shadow-[inset_0_0_0_1px_rgba(0,0,0,0.15)]`;
